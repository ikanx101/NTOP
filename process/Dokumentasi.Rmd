...
df_order %>%
  mutate(armada_kirim  = sample(5,nrow(df_order),replace = T)) %>% 
  rowwise() %>% 
...
Berikut adalah _objective function_ dan beberapa _constraints_ yang dituliskan dalam satu _function_:

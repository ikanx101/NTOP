...
- $\mathcal{T} = \{1,2,..,10\}$ sebagai himpunan toko yang memesan produk ke Nutrifood.
- $\mathcal{M} = \{ 1,2,..,6 \}$ sebagai himpunan jenis armada yang bisa disewa Nutrifood.
- $\mathcal{G} = \{1,2\}$ sebagai himpunan gudang yang men-_supply_ semua toko yang ada.
- $\mathcal{D} = \{1,2,..,20\}$ sebagai himpunan tanggal pengiriman produk dari Nutrifood ke toko.
...
- $\forall t \in \mathcal{T}, tgl1_t$ sebagai tanggal minimal pengiriman produk oleh Nutrifood.
- $\forall t \in \mathcal{T}, tgl2_t$ sebagai tanggal maksimal pengiriman produk oleh Nutrifood.
- $\forall t_1,t_2 \in \mathcal{T}, J_{t_1 t_2}$ sebagai jarak antara toko ke $t_1$ dan $t_2$.
...
- $\forall m \in \mathcal{M}, ava_m$ sebagai banyaknya armada $m$ yang bisa disewa.
